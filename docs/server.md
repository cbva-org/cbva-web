...
Prefer separate files for server functions. There are extensive examples in the @src/functions directory. Do not write any new code in @src/data. We are keeping things in separate files in @src/functions now
