...
const getPageBlocks = createServerFn()
  .inputValidator(
...
const contentPageBlocksQueryOptions = (path: string) =>
  queryOptions({
...
function RouteComponent() {
  const { queryKey } = contentPageBlocksQueryOptions("ratings");
  ...
  console.log(genderDivisionKey, blocks);
