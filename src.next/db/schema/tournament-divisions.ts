...
import { integer, pgTable, serial, text, unique, uuid } from "drizzle-orm/pg-core";
...
export const selectTournamentDivisionSchema = createSelectSchema(tournamentDivisions);
export const createTournamentDivisionSchema = createInsertSchema(tournamentDivisions).omit({
	id: true,
});
export const updateTournamentDivisionSchema = createUpdateSchema(tournamentDivisions);
...
export type UpdateTournamentDivision = z.infer<typeof updateTournamentDivisionSchema>;
