...
import { doublePrecision, integer, pgTable, serial, text, uuid } from "drizzle-orm/pg-core";
...
export const selectTournamentDivisionTeamSchema = createSelectSchema(tournamentDivisionTeams);
export const createTournamentDivisionTeamSchema = createInsertSchema(tournamentDivisionTeams).omit({
	id: true,
});
export const updateTournamentDivisionTeamSchema = createUpdateSchema(tournamentDivisionTeams);

export type TournamentDivisionTeam = z.infer<typeof selectTournamentDivisionTeamSchema>;
export type CreateTournamentDivisionTeam = z.infer<typeof createTournamentDivisionTeamSchema>;
export type UpdateTournamentDivisionTeam = z.infer<typeof updateTournamentDivisionTeamSchema>;
