...
export function InformationPanel({
  ...
  const { mutateAsync: updateVenue } = useUpdateVenue([tournamentQuery.queryKey]);
      ...
      <div className="max-w-4xl mx-auto pt-12 px-3">
        <h4 className={subtitle()}>
          ...
          <RichTextEditorModal
            ...
            title={<h3 className={title({size: 'sm'})}>Update Venue Description</h3>}
            initialValue={
        ...
        <div className="flex flex-col gap-3 border-t py-12 border-gray-300">
          ...
          >
            ...
            <RichTextEditorModal
              name="venue-directions"
              title={<h3 className={title({size: 'sm'})}>Update Venue Directions</h3>}
              initialValue={
