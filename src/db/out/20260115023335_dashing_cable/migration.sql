CREATE TABLE "match_refs" (
	...
	"abandoned" boolean,
	CONSTRAINT "match_ref_teams_type_exclusive" CHECK (("pool_match_id" IS NOT NULL AND "playoff_match_id" IS NULL) OR ("pool_match_id" IS NULL AND "playoff_match_id" IS NOT NULL))
);
--> statement-breakpoint
CREATE INDEX "match_ref_teams_pool_match_idx" ON "match_refs" ("pool_match_id");--> statement-breakpoint
CREATE INDEX "match_ref_teams_playoff_match_idx" ON "match_refs" ("playoff_match_id");--> statement-breakpoint
